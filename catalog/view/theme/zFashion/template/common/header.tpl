...
<!-- BEGIN Enable view Extension -->
<!--<link rel="stylesheet" href="catalog/view/theme/zFashion/stylesheet/reset.css"> <!-- CSS reset -->
<!--<link rel="stylesheet" href="catalog/view/theme/zFashion/stylesheet/popup_style.css"> <!-- Resource style -->
<!--<script src="catalog/view/javascript/modernizr.js"></script> <!-- Modernizr -->
<!--<script src="catalog/view/javascript/velocity.min.js"></script>
<script src="catalog/view/javascript/main_popup.js"></script> <!-- Resource jQuery -->
<!--END -->
...
<nav id="top">
  <div class="fixed_Header container">
    <div class="row">
    	<div class="col-md-2">
		<?php echo $currency; ?>
		<?php echo $language; ?>
